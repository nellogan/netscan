...
void SplitCIDR(std::string& cidr_string, size_t slash_pos, std::string& ip_addr_string, int& num_prefix_bits)
{
    ...
    {
        throw std::invalid_argument("Error: SplitCIDR, invalid IPv4 prefix: must be greater than 8 and less than 32.\n");
    }
}
...
void NetScan::DetermineAndRunOperation(char* cidr_char_string, Mode mode)
{
